  ...
  return (
    <>
      <div id="version" className="md:scroll-m-[180px] scroll-m-28">
            ...
            PackageVersions && PackageVersions.map((item) => {
              return (
                <div key={item.id} className="lg:w-1/5 md:w-full text-center lg:border-b-0 border-b lg:border-e lg:last:border-e-0 last:border-b-0 border-border dark:border-darkborder">
                  <Image src={item.img} alt={item.packageName} width={40} height={40} className="mx-auto" />
        ...
        <div className="mt-5">
          <p className="text-base font-medium text-midnight_text dark:text-white dark:text-opacity-50">Mutlu Pazartesiler Tailwind NextJs Template is built with Tailwindcss and Nextjs.</p>
