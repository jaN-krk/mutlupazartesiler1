      ...
      <section className="py-12">
        <div className="container mx-auto lg:max-w-6xl md:max-w-screen-md px-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            <div>
              <h2 className="text-2xl font-semibold text-black dark:text-white">Mutlu Pazartesiler nedir?</h2>
              ...
              <h3 className="mt-6 font-semibold">Ne yapıyoruz?</h3>
              ...
              <h3 className="mt-6 font-semibold">Çalışma Alanlarımız</h3>
              ...
              <p className="mt-6 font-semibold">Kısacası:</p>
              <p className="text-black/70 dark:text-white/70">Biz, pazartesileri daha mutlu kılmak için buradayız.</p>
            ...
            <div>
              <div className="rounded-3xl overflow-hidden">
                <img src="/images/hero/fulya-hanim-hakkimizda.png" alt="Hakkımızda" className="w-50px h-100px object-cover" />
              </div>
            </div>
          </div>
        </div>
